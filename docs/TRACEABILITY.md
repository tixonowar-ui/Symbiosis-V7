...
> перечислена в `PRESENTED_FORM_IDS` (`src/host/protocol-vocabulary.ts`),
...
| ----- | ----------------- | ----: | ----------: | -----: | --------------: | -----: |
| M3    | Активные правила  |   699 |          18 |  2.6 % |              18 |  2.6 % |
| M3    | Tombstone-правила |    40 |           0 |    0 % |               0 |    0 % |
| M3    | Entity lifecycles |    19 |           4 | 21.1 % |               4 | 21.1 % |
| M4    | Проекции ролей    |     3 |           3 |  100 % |               3 |  100 % |
| M4    | Guard-состояния   |    10 |          10 |  100 % |               5 |   50 % |
| M5–M6 | Формы             |   376 |          20 |  5.3 % |              41 | 10.9 % |
| M5–M6 | Переходы          |  1672 |           0 |    0 % |              13 |  0.8 % |
| M8    | Journeys          |    66 |           0 |    0 % |               0 |    0 % |
| M8    | Requirements      |    91 |           0 |    0 % |               4 |  4.4 % |
...
| ----------------------------- | ------- | ----: | ----------: | --------------: |
| Анимации                      | `ANI-`  |    11 |           0 |               0 |
| Приложение и локальные данные | `APP-`  |    11 |           3 |              11 |
| Создание локального персонажа | `CHR-`  |    44 |          17 |              19 |
...
| Повседневная проекция игрока  | `PLY-`  |    35 |           0 |               3 |
| Длительный отдых              | `RST-`  |    15 |           0 |               0 |
| Настройки                     | `SET-`  |     6 |           0 |               0 |
| Системные состояния           | `SYS-`  |    29 |           0 |               1 |
